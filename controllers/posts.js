...
module.exports = {
  ...
  getFeed: async (req, res) => {
    try {
      const posts = await Post.find().sort({ createdAt: "asc" }).lean(); // find and sort in ascending order. lean makes it way faster to get the info you need. lean is mongoose helping us. Post is the name of a model which contains a schema. 
